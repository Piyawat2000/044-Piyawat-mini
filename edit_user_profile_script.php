...
setTimeout(function() {
    ...
    window.location = "edit_profile_user.php?id='.urlencode($id).'"; // Redirect to.. ปรับแก ้ชอไฟล์ตามที่ต้องการให ้ไป ื่
        });
    }, 1000);
</script>';
    exit();
...
if ($update_info && $update_users && $upload_result) {
    echo '<script>
                setTimeout(function() {
                    ...
                    window.location = "userInfo_view.php?id='.urlencode($id).'"; // Redirect to.. ปรับแก ้ชอไฟล์ตามที่ต้องการให ้ไป ื่
                });
                    }, 1000);
                    </script>';
}else{
